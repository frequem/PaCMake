function(pacmake_patch packageName packageVariant packageVersion workingDirectory)
	file(COPY "${PACMAKE_HOME}/package/imgui/${packageVariant}/${packageVersion}/src/orig/backends/imgui_impl_vulkan.h" DESTINATION "${workingDirectory}/")
	file(COPY "${PACMAKE_HOME}/package/imgui/${packageVariant}/${packageVersion}/src/orig/backends/imgui_impl_vulkan.cpp" DESTINATION "${workingDirectory}/")
