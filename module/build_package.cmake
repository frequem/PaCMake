...
function(pacmake_transfer_system_variables out_variables)
	function(add_var varList newVar)
		cmake_parse_arguments(args "SETONLY" "" "" ${ARGN})
		if(NOT args_SETONLY OR NOT "${${newVar}}" STREQUAL "")
	...
	add_var(vars CMAKE_C_COMPILER SETONLY)
	add_var(vars CMAKE_CXX_COMPILER SETONLY)
	add_var(vars CMAKE_RC_COMPILER SETONLY)
	add_var(vars CMAKE_MC_COMPILER SETONLY)
	add_var(vars CMAKE_Fortran_COMPILER SETONLY)
	
	#add_var(vars CMAKE_FIND_ROOT_PATH)
	add_var(vars CMAKE_FIND_ROOT_PATH_MODE_PROGRAM SETONLY)
	add_var(vars CMAKE_FIND_ROOT_PATH_MODE_LIBRARY SETONLY)
	add_var(vars CMAKE_FIND_ROOT_PATH_MODE_INCLUDE SETONLY)
	add_var(vars CMAKE_FIND_ROOT_PATH_MODE_PACKAGE SETONLY)
	
	add_var(vars CMAKE_CROSSCOMPILING_EMULATOR SETONLY)
	add_var(vars CMAKE_AR:FILEPATH SETONLY)
	add_var(vars CMAKE_RANLIB:FILEPATH SETONLY)
