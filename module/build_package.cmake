...
function(pacmake_transfer_system_variables out_variables)
	...
	if(ANDROID)
		add_var(vars CMAKE_TOOLCHAIN_FILE)
		add_var(vars CMAKE_SYSTEM_NAME)
		add_var(vars CMAKE_EXPORT_COMPILE_COMMANDS)
		add_var(vars ANDROID_PLATFORM)
		add_var(vars ANDROID_ABI)
		add_var(vars CMAKE_ANDROID_ARCH_ABI)
		add_var(vars ANDROID_NDK)
		add_var(vars CMAKE_ANDROID_NDK)
		add_var(vars CMAKE_ANDROID_NDK)
		add_var(vars CMAKE_MAKE_PROGRAM)
	endif()
