# PaCMake
C/C++ cross-platform package manager written in CMake for easy integration.
## User How-to
#### Setup
...
```cmake
project(test)
pacmake_add_package(GTest SHARED VERSION 1.8.1)
add_executable(test ${test_sources})
target_link_libraries(test PUBLIC GTest::gtest)
```
Both the library type (here: SHARED) and version (here: VERSION 1.8.1) arguments are optional.
